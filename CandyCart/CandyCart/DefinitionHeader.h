...
#define MAIN_URL @"http://atest.artbloom.co/"

//Leave empty if you didn't install any SSL in your server e.g https://candycart.appress.me/
#define MAIN_URL_HTTPS @""
...
// UIWEBView Header Setting. Will effect in UIWebView Page detail and post detail.
// Please put your JS/CSS file in JS folder
// You can use URL if you want but will effect the load performance...
// e.g JQUERY @"http://codeorigin.jquery.com/jquery-2.0.3.min.js"
