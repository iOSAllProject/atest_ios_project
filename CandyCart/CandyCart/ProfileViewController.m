...
-(void)myProfile{
    ...
    NSString *avatarURL =[[NSString alloc] init];
    
    if ( [userData objectForKey:@"avatar"] == [NSNull null] ) {
        NSLog(@"avatar null");
        avatarURL = @"http://atest.artbloom.co/wp-content/plugins/wp-user-avatar/images/wpua-96x96.png";
    }
    else {
        avatarURL = [userData objectForKey:@"avatar"];
    }
    
    [profileImg setImageWithURL:[NSURL URLWithString: avatarURL]
